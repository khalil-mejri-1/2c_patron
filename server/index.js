...
// Create a dedicated disk storage for videos because memoryStorage doesn't provide filenames
const videoStorage = multer.diskStorage({
    destination: (req, file, cb) => {
        const dir = path.join(__dirname, 'uploads', 'specialized-videos');
...
app.get('/', (req, res) => {
    res.send('Hello World! Connected to Express and MongoDB v3. 5/12/2026');
});
...
app.post('/api/specialized-videos', uploadVideo.fields([
...
app.post('/api/specialized-videos/upload', uploadVideo.single('video'), (req, res) => {
    if (!req.file) {
...
app.put('/api/specialized-videos/:id', uploadVideo.fields([
    { name: 'video_fr', maxCount: 1 },
    { name: 'video_ar', maxCount: 1 },
    { name: 'video_en', maxCount: 1 },
    { name: 'video', maxCount: 1 }
