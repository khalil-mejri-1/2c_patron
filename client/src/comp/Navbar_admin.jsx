...
import {
    ...
    FaEnvelope, FaComments, FaCrown, FaVideo, FaCog, FaChartBar, FaHome, FaSignOutAlt
} from 'react-icons/fa';
        ...
        <nav className="navbar-admin">
            ...
            <div className={`navbar-admin-links ${isMenuOpen ? 'open' : ''}`}>
                ...
                <button 
                  ...
                  className="navbar-admin-link logout-btn"
                  style={{ 
                    display: 'flex', 
                    alignItems: 'center', 
                    background: 'none', 
                ...
                >
                  <span style={{ marginRight: '8px', display: 'flex', alignItems: 'center' }}><FaSignOutAlt /></span>
                  Déconnexion
                </button>
            </div>
        </nav>
