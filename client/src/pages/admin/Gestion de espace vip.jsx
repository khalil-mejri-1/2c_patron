...
import { FaPlusCircle, FaTrash, FaEdit, FaSave, FaBookOpen, FaVideo, FaLayerGroup, FaSpinner, FaExclamationTriangle, FaTimes, FaImage, FaClock, FaCheckCircle, FaUpload } from 'react-icons/fa';
...
export default function Gestion_de_espace_vip() {
    ...
    const handleFileUpload = async (e, type = 'new') => {
                        ...
                        <div className="premium-form-group" style={{ gridColumn: 'span 4' }}>
                            ...
                            <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                                <input 
                                    ...
                                    placeholder="Lien de l'image (auto-rempli après upload)" 
                                    readOnly 
                                    style={{ flex: 1 }}
                                />
                                <input 
                                ...
                                <button 
                                    ...
                                    style={{ padding: '10px 15px', whiteSpace: 'nowrap', minWidth: 'auto' }}
                                    disabled={isUploading}
                                >
                                    {isUploading ? <FaSpinner className="spinner" /> : <FaUpload />} {isUploading ? 'Upload...' : 'Choisir une image'}
                                </button>
                            </div>
                            {newCategory.image && (
                                <div style={{ marginTop: '10px' }}>
                                    <img src={newCategory.image} alt="Preview" style={{ width: '100px', height: '60px', objectFit: 'cover', borderRadius: '8px', border: '1px solid #e2e8f0' }} />
                                </div>
                            )}
                        </div>
                        <div className="premium-form-group" style={{ gridColumn: 'span 4' }}>
                                ...
                                <div style={{ flex: 1 }}>
                                    {editingId === cat._id ? (
                                        <div className="premium-form-grid" style={{ gap: '10px' }}>
                                            ...
                                            <div style={{ gridColumn: 'span 4', display: 'flex', gap: '10px', alignItems: 'center' }}>
                                                <input 
                                                    type="text" 
