...
import { FaTimes, FaPlusCircle, FaTrash, FaSave, FaVideo, FaLayerGroup, FaExclamationTriangle, FaCog, FaUpload, FaSpinner } from 'react-icons/fa';
...
export default function GestionCoursSpecialises({ onClose }) {
    ...
    const handleFileUpload = async (e, index) => {
        ...
        try {
            ...
            handleCourseChange(index, 'image', res.data.url);
                            ...
                            <div className="premium-form-grid" style={{ gap: '15px' }}>
                                ...
                                <div className="premium-form-group" style={{ flex: 1 }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                                        <input type="text" value={course.image} readOnly placeholder="Lien image" style={{ flex: 1, padding: '12px', borderRadius: '10px', border: '1px solid #ced4da' }} />
                                        <input 
                                            type="file" 
                                            id={`file-input-${i}`}
                                        ...
                                        >
                                            {uploadingIdx === i ? <FaSpinner className="spinner" /> : <FaUpload />}
                                        </button>
                                    </div>
                                    {course.image && (
                                        <div style={{ marginTop: '5px' }}>
                                            <img src={course.image} alt="Preview" style={{ width: '80px', height: '45px', objectFit: 'cover', borderRadius: '5px', border: '1px solid #ced4da' }} />
                                        </div>
                                    )}
                                </div>
                            </div>
